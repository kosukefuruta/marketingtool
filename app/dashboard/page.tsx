...
export default async function DashboardPage() {
  ...
  return <div className="stack">
    ...
    <div className="grid">
      ...
      <section className="card"><h2>契約</h2>{paid ? <><p>有料プランを利用中です。</p><Link href="/settings/billing">契約を管理</Link></> : <form className="stack" action={startCheckout}><p>SEO施策の管理を始めるには有料プランを契約してください。</p><button className="button">月額1,980円で始める</button></form>}</section>
    </div>
